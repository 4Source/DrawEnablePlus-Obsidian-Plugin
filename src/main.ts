...
interface DrawEnablePlusPluginSettings {
	settingsNumb1: string;
}

const DEFAULT_SETTINGS: DrawEnablePlusPluginSettings = {
...
class SettingTab extends PluginSettingTab {
	plugin: DrawEnablePlus;

	constructor(app: App, plugin: DrawEnablePlus) {
		super(app, plugin);
		this.plugin = plugin;
	}
